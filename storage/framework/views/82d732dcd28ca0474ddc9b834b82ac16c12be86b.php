        ...
        <div class="mb-4">
            <div class="input-group border-bottom border-width-2 border-color-1 py-2">
                ...
                <div class="g-map-place border-0 p-0 form-control  height-40 d-flex" >
                    <input type="text" name="map_place" placeholder="<?php echo e(__("وجهتك")); ?>"  value="<?php echo e(request()->input('map_place')); ?>" class="font-weight-bold font-size-16 shadow-none hero-form font-weight-bold border-0 p-0">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/umrah/themes/Mytravel/Boat/Views/frontend/layouts/search/fields/location.blade.php ENDPATH**/ ?>