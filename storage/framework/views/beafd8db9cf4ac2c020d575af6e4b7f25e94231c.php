    ...
    <div class="mb-3">
        <div class="d-block d-md-flex flex-horizontal-center mb-2 mb-md-0">
            ...
            <?php if($row->getReviewEnable()): ?>
                ...
                <span class="font-size-14 text-gray-1 ml-1"><?php echo e(__(":number تقييم",['number'=>$review_score['total_review']])); ?></span>
            <?php endif; ?>
    ...
    <ul class="list-group list-group-horizontal custom-social-share">
        ...
        <li class="list-group-item px-1 border-0">
            ...
            <div id="shareDropdown<?php echo e($row->id); ?>" class="dropdown-menu dropdown-unfold dropdown-menu-right mt-0 px-3 min-width-3" aria-labelledby="shareDropdownInvoker<?php echo e($row->id); ?>">
                <a class="btn btn-icon btn-pill btn-bg-transparent transition-3d-hover  btn-xs btn-soft-dark  facebook mb-3" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e($row->getDetailUrl()); ?>&amp;title=<?php echo e($translation->title); ?>" target="_blank" rel="noopener" original-title="<?php echo e(__("فيسبوك")); ?>">
                    <span class="font-size-15 fa fa-facebook-f btn-icon__inner"></span>
                </a>
                <br/>
                <a class="btn btn-icon btn-pill btn-bg-transparent transition-3d-hover  btn-xs btn-soft-dark  twitter" href="https://twitter.com/share?url=<?php echo e($row->getDetailUrl()); ?>&amp;title=<?php echo e($translation->title); ?>" target="_blank" rel="noopener" original-title="<?php echo e(__("تويتر")); ?>">
    ...
    <ul class="list-group list-group-borderless list-group-horizontal flex-center-between text-center mx-md-4 flex-wrap">
        <?php if($row->passenger): ?>
            <li class="list-group-item text-lh-sm ">
                ...
                <div class="text-gray-1"><?php echo e($row->passenger); ?> <?php echo e(__("مقاعد")); ?></div>
            </li>
        <?php endif; ?>
        <?php if($row->gear): ?>
            <li class="list-group-item text-lh-sm ">
                <i class="icon-gear text-primary font-size-50 mb-1 "></i>
                <div class="text-gray-1"> <?php echo e($row->gear); ?> <?php echo e(__("علبة التروس")); ?></div>
            </li>
        <?php endif; ?>
        <?php if($row->baggage): ?>
            <li class="list-group-item text-lh-sm ">
                <i class="icon-baggage text-primary font-size-50 mb-1 "></i>
                <div class="text-gray-1"> <?php echo e($row->baggage); ?> <?php echo e(__(" حقائب")); ?></div>
            </li>
        <?php endif; ?>
        <?php if(!empty($row->door)): ?>
            <li class="list-group-item text-lh-sm ">
                <i class="icon-door text-primary font-size-50 mb-1 "></i>
                <div class="text-gray-1"><?php echo e($row->door); ?> <?php echo e(__("أبواب")); ?></div>
            </li>
        <?php endif; ?>
    </ul>
</div>
    ...
    <div class="position-relative">
        <div id="sliderSyncingNav" class="travel-slick-carousel u-slick mb-2"
            ...
            <?php $__currentLoopData = $row->getGallery(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="js-slide">
                    <img class="img-fluid border-radius-3" src="<?php echo e($item['large']); ?>" alt="<?php echo e(__("معرض الصور")); ?>">
                </div>
                ...
                <div class="flex-horizontal-center">
                    <a class="travel-fancybox btn btn-white transition-3d-hover py-2 px-md-5 px-3 shadow-6 mr-1" href="javascript:;"
                       ...
                       data-speed="700">
                        ...
                        <span class="d-none d-md-inline"><?php echo e(__("فيديو")); ?></span>
                    </a>
                </div>
            </div>
        <?php endif; ?>
        <div id="sliderSyncingThumb" class="travel-slick-carousel u-slick u-slick--gutters-4 u-slick--transform-off"
            ...
            <?php $__currentLoopData = $row->getGallery(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="js-slide" style="cursor: pointer;">
                    <img class="img-fluid border-radius-3 height-110" src="<?php echo e($item['thumb']); ?>" alt="<?php echo e(__("معرض الصور")); ?>">
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<?php if($translation->faqs): ?>
    <div class="g-faq">
        <h3 class="font-size-21 font-weight-bold text-dark mb-4"> <?php echo e(__("الأسئلة الشائعة")); ?> </h3>
...
<?php if($row->map_lat && $row->map_lng): ?>
    <div class="mt-4">
        <h3 class="font-size-21 font-weight-bold text-dark mb-4"><?php echo e(__("الموقع")); ?></h3>
        <div class="location-map">
            <div id="map_content"></div>
        </div>
    </div>
<?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/umrah/themes/Mytravel/Car/Views/frontend/layouts/details/detail.blade.php ENDPATH**/ ?>