    ...
    <div class="bravo-list-car-related product-card-carousel-block product-card-carousel-v5 mb-3">
        <div class="space-1">
            <div class="w-md-80 w-lg-50 text-center mx-md-auto mt-3">
                <h2 class="section-title text-black font-size-30 font-weight-bold mb-0"><?php echo e(__("قد تعجبك أيضا...")); ?></h2>
            </div>
...
<?php endif; ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/umrah/themes/Mytravel/Car/Views/frontend/layouts/details/related.blade.php ENDPATH**/ ?>