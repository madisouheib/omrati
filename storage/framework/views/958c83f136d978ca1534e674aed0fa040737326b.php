<div class="bravo_topbar u-header__hide-content u-header__topbar u-header__topbar-lg border-bottom <?php if(!empty($is_home)|| !empty($header_transparent)): ?>border-color-white <?php else: ?>  border-color-8 <?php endif; ?>" style="background-color:#0A704B; ">
                   ...
                   <?php if(!Auth::id()): ?>
                       <a href="javascript:;" class="d-flex align-items-center text-white py-3"
                          data-toggle="modal" data-target="#login">
                           ...
                           <span class="d-inline-block font-size-14 mr-1"><?php echo e(__("تسجيل الدخول أو التسجيل")); ?></span>
                       </a>
                   <?php else: ?>
                       <div class="d-flex align-items-center text-white py-3 dropdown">
                           ...
                           <span class="d-inline-block font-size-14 mr-1 dropdown-nav-link" data-toggle="dropdown">
                            <?php echo e(__("مرحباً، :name",['name'=>Auth::user()->getDisplayName()])); ?>
                           ...
                           <ul class="dropdown-menu dropdown-menu-user text-left dropdown">
                               <?php if(empty( setting_item('wallet_module_disable') )): ?>
                                   <li class="credit_amount">
                                       <a href="<?php echo e(route('user.wallet')); ?>"><i class="fa fa-money"></i> <?php echo e(__("الرصيد: :amount",['amount'=>auth()->user()->balance])); ?></a>
                                   </li>
                               <?php endif; ?>
                               <?php if(is_vendor()): ?>
                                   <li class=""><a href="<?php echo e(route('vendor.dashboard')); ?>" class=""><i class="icon ion-md-analytics"></i> <?php echo e(__("لوحة التحكم للبائع")); ?></a></li>
                               <?php endif; ?>
                               <li class="<?php if(is_vendor()): ?>  <?php endif; ?>">
                                   <a href="<?php echo e(route('user.profile.index')); ?>"><i class="icon ion-md-construct"></i> <?php echo e(__("ملفي الشخصي")); ?></a>
                               </li>
                               <?php if(setting_item('inbox_enable')): ?>
                                   <li class=""><a href="<?php echo e(route('user.chat')); ?>"><i class="fa fa-comments"></i> <?php echo e(__("الرسائل")); ?></a></li>
                               <?php endif; ?>
                               <li class=""><a href="<?php echo e(route('user.booking_history')); ?>"><i class="fa fa-clock-o"></i> <?php echo e(__("سلة الحجوزات")); ?></a></li>
                               <li class=""><a href="<?php echo e(route('user.change_password')); ?>"><i class="fa fa-lock"></i> <?php echo e(__("تغيير كلمة المرور")); ?></a></li>
                               <?php if(is_admin()): ?>
                                   <li class=""><a href="<?php echo e(url('/admin')); ?>"><i class="icon ion-ios-ribbon"></i> <?php echo e(__("لوحة التحكم للمشرف")); ?></a></li>
                               <?php endif; ?>
                               <li class="">
                                   <a  href="#" onclick="event.preventDefault(); document.getElementById('logout-form-topbar').submit();"><i class="fa fa-sign-out"></i> <?php echo e(__('تسجيل الخروج')); ?></a>
                               </li>
                           </ul>
...
<?php /**PATH /Users/souheibmadi/Documents/umrahproject/umrah/themes/Mytravel/Layout/parts/topbar.blade.php ENDPATH**/ ?>