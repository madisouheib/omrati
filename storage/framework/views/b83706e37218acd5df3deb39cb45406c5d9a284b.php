<div class="d-block d-md-flex flex-center-between align-items-start mb-3">
    <div class="mb-1">
        <div class="mb-2 mb-md-0">
            <h1 class="font-size-26 font-weight-bold mb-1 mr-3"><?php echo clean($translation->title); ?></h1>
        </div>
                ...
                <div class="ml-2 service-review review-<?php echo e($score_total); ?>">
                    <div class="d-inline-flex align-items-center font-size-17 text-lh-1 text-primary">
                        ...
                        <?php if($reviewData['total_review'] > 1): ?>
                                <?php echo e(__("تقييمات :number",["number"=>$reviewData['total_review'] ])); ?>

                            <?php else: ?>
                                <?php echo e(__("تقييم :number",["number"=>$reviewData['total_review'] ])); ?>
    ...
    <ul class="list-group list-group-borderless list-group-horizontal row">
        ...
        <?php if($row->duration): ?>
            <li class="col-md-4 flex-horizontal-center list-group-item text-lh-sm mb-2 border-0">
                ...
                <div class="ml-1 text-gray-1"><?php echo e(__("الحد الأقصى للأشخاص")); ?> : <?php echo e($row->max_people); ?></div>
            </li>
        <?php endif; ?>
        <?php if($row->wifi_available): ?>
            <li class="col-md-4 flex-horizontal-center list-group-item text-lh-sm mb-2 border-0">
                <i class="flaticon-wifi-signal text-primary font-size-22 mr-2 d-block"></i>
                <div class="ml-1 text-gray-1"><?php echo e(__("واي فاي متوفر")); ?></div>
            </li>
        <?php endif; ?>
        ...
        <?php if($row->min_age): ?>
            <li class="col-md-4 flex-horizontal-center list-group-item text-lh-sm mb-2 border-0">
                ...
                <div class="ml-1 text-gray-1 "><?php echo e(__('الحد الأدنى للعمر:')); ?> <?php echo e($row->min_age); ?></div>
            </li>
        <?php endif; ?>
        <?php if($row->pickup): ?>
            <li class="col-md-4 flex-horizontal-center list-group-item text-lh-sm mb-2 border-0">
                <i class="flaticon-pin text-primary font-size-22 mr-2 d-block"></i>
                <div class="ml-1 text-gray-1"><?php echo e(__("الانطلاق من:")); ?> <?php echo e(__("$row->pickup")); ?></div>
            </li>
        <?php endif; ?>
    </ul>
</div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/umrah/themes/Mytravel/Tour/Views/frontend/layouts/details/tour-detail.blade.php ENDPATH**/ ?>