    ...
    <div class="col dropdown-custom px-0 mb-4 form-select-guests">
        ...
        <div class="flex-horizontal-center border-bottom border-width-2 border-color-1 py-2 d-flex dropdown-toggle" data-toggle="dropdown">
            ...
            <div class="text-black font-size-16 font-weight-semi-bold mr-auto">
                <div class="render">
                    <span class="adults"><span class="one <?php if($adults >1): ?> d-none <?php endif; ?>"><?php echo e(__('بالغ 1')); ?></span> <span class="<?php if($adults <= 1): ?> d-none <?php endif; ?> multi" data-html="<?php echo e(__(':count بالغين',['count'=>request()->query('adults',1)])); ?>"><?php echo e(__(':count بالغين',['count'=>request()->query('adults',1)])); ?></span></span>
                    -
                    <span class="children">
                        <span class="one <?php if($children >1): ?> d-none <?php endif; ?>" data-html="<?php echo e(__(':count طفل',['count'=>request()->query('children',0)])); ?>"><?php echo e(__(':count طفل',['count'=>request()->query('children',0)])); ?></span>
                        <span class="multi <?php if($children <=1): ?> d-none <?php endif; ?>" data-html="<?php echo e(__(':count أطفال',['count'=>request()->query('children',0)])); ?>"><?php echo e(__(':count أطفال',['count'=>request()->query('children',0)])); ?></span>
                    </span>
                </div>
            </div>
        </div>
        <div class="dropdown-menu select-guests-dropdown">
            <div class="dropdown-item-row">
                <div class="label"><?php echo e(__('البالغين')); ?></div>
                <div class="val">
            ...
            <div class="dropdown-item-row">
                <div class="label"><?php echo e(__('الأطفال')); ?></div>
                <div class="val">
...
<?php /**PATH /Users/souheibmadi/Documents/umrahproject/umrah/themes/Mytravel/Hotel/Views/frontend/layouts/search/fields/guests.blade.php ENDPATH**/ ?>