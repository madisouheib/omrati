            ...
            <div class="border border-color-7 rounded mb-5">
                <div class="border-bottom">
                    <?php if($row->discount_percent): ?>
                        <div class="sale-box">
                            <div class="ribbon ribbon--red"><?php echo e(__("وفر :text",['text'=>$row->discount_percent])); ?></div>
                        </div>
                    <?php endif; ?>
                    <div class="p-4">
                        <span class="font-size-14"><?php echo e(__("ابتداءا من")); ?></span>
                ...
                <div class="nav-enquiry" v-if="is_form_enquiry_and_book">
                    <div class="enquiry-item active" >
                        <span><?php echo e(__("حجز")); ?></span>
                    </div>
                    <div class="enquiry-item" data-toggle="modal" data-target="#enquiry_form_modal">
                        <span><?php echo e(__("استفسار")); ?></span>
                    </div>
                </div>
                <div class="form-book" :class="{'d-none':enquiry_type!='book'}">
                    <div class="p-4">
                        <span class="d-block text-gray-1 font-weight-normal mb-0 text-left"><?php echo e(__("تاريخ الاستلام")); ?></span>
                        <div class="mb-4">
                                    ...
                                    <div class="render check-in-render mb-1">
                                        <small>
                                            <?php if($row->min_day_before_booking > 1): ?>
                                                - <?php echo e(__("احجز :number أيام مقدمًا",["number"=>$row->min_day_before_booking])); ?>

                                            <?php else: ?>
                                                - <?php echo e(__("احجز :number يوم مقدمًا",["number"=>$row->min_day_before_booking])); ?>
                                    ...
                                    <div class="render check-in-render mb-1">
                                        <small>
                                            <?php if($row->min_day_stays > 1): ?>
                                                - <?php echo e(__("البقاء لمدة :number أيام على الأقل",["number"=>$row->min_day_stays])); ?>

                                            <?php else: ?>
                                                - <?php echo e(__("البقاء لمدة :number يوم على الأقل",["number"=>$row->min_day_stays])); ?>
                        ...
                        <div class="mb-4 border-bottom border-width-2 border-color-1 pb-1" v-if="extra_price.length">
                            <h4 class="flex-center-between mb-1 font-size-16 text-dark font-weight-bold"><?php echo e(__('أسعار إضافية:')); ?></h4>
                        ...
                        <ul class="form-section-total mb-4  list-unstyled  pb-1" v-if="total_price > 0">
                            <li>
                                <label><?php echo e(__("المجموع")); ?></label>
                                <span class="price">{{total_price_html}}</span>
                            </li>
                            <li v-if="is_deposit_ready">
                                <label for=""><?php echo e(__("ادفع الآن")); ?></label>
                        ...
                        <div class="text-center">
                            <button class="btn btn-primary d-flex align-items-center justify-content-center  height-60 w-100 mb-xl-0 mb-lg-1 transition-3d-hover font-weight-bold" @click="doSubmit($event)" :class="{'disabled':onSubmit,'btn-success':(step == 2),'btn-primary':step == 1}" name="submit">
                                <span class="stop-color-white"><?php echo e(__("احجز الآن")); ?></span>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/umrah/themes/Mytravel/Car/Views/frontend/layouts/details/form-book.blade.php ENDPATH**/ ?>