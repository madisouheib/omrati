...
<div class="card transition-3d-hover shadow-hover-2 item-loop w-100 <?php echo e($wrap_class ?? ''); ?>">
    ...
    <div class="position-absolute top-0 left-0 pt-4 pl-3 featured">
        <?php if($row->is_featured == "1"): ?>
            <span class="badge badge-pill bg-white text-primary px-4 mr-3 py-2 font-size-14 font-weight-normal"><?php echo e(__("مميزة")); ?></span>
        <?php endif; ?>
                ...
                <ul class="list-unstyled mb-0">
                    <li class="media mb-2 text-gray-1 align-items-center">
                        ...
                        <div class="media-body font-size-1">
                            <?php echo e($row->passenger); ?> <small><?php echo e(__("مقاعد")); ?></small>
                        </div>
                    </li>
                    <li class="media mb-2 text-gray-1 align-items-center">
                        <small class="mr-2">
            ...
            <div class="col-6">
                <ul class="list-unstyled mb-0">
                    <li class="media mb-2 text-gray-1 align-items-center">
                        ...
                        <div class="media-body font-size-1">
                            <?php echo e($row->baggage); ?> <small><?php echo e(__("حقائب")); ?></small>
                        </div>
                    </li>
                    <li class="media mb-2 text-gray-1 align-items-center">
                        <small class="mr-2">
                        ...
                        <div class="media-body font-size-1">
                            <?php echo e($row->door); ?> <small><?php echo e(__("أبواب")); ?></small>
                        </div>
                    </li>
                </ul>
            </div>
...
<?php /**PATH /Users/souheibmadi/Documents/umrahproject/umrah/themes/Mytravel/Car/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>