                ...
                <div class="py-xl-10 py-5">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter justify-content-center mb-0">
                            <li class="breadcrumb-item font-size-14"> <a class="text-white" href="<?php echo e(url("/")); ?>"><?php echo e(__("الرئيسية")); ?></a> </li>
    ...
    <div class="border-bottom border-color-8 pb-6 pb-lg-9 mb-6 mb-lg-8">
        <div class="container mb-10">
            <div class="w-md-80 w-lg-50 text-center mx-md-auto my-3">
                <h2 class="section-title text-black font-size-30 font-weight-bold mb-5 pb-xl-1"><?php echo e(__("أرسل لنا رسالة")); ?></h2>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 mb-5">
                            <div class="js-form-message">
                                <input type="text" class="form-control" name="name" placeholder="<?php echo e(__("الاسم")); ?>" >
                            </div>
                        </div>
                        <div class="col-sm-6 mb-5">
                            <div class="js-form-message">
                                <input type="email" class="form-control" name="email" placeholder="<?php echo e(__("البريد الإلكتروني")); ?>" >
                            </div>
                        </div>
                        <div class="col-sm-12 mb-5">
                            <div class="js-form-message">
                                <div class="input-group">
                                    <textarea class="form-control" rows="6" cols="77" name="message" placeholder="<?php echo e(__('الرسالة')); ?>"></textarea>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/umrah/themes/Mytravel/Contact/Views/frontend/blocks/contact/index.blade.php ENDPATH**/ ?>