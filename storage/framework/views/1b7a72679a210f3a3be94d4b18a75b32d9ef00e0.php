    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content relative">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo e(__('تسجيل الدخول')); ?></h4>
                <span class="c-pointer" data-dismiss="modal" aria-label="إغلاق">
                    <i class="input-icon field-icon fa">
                        <img src="<?php echo e(url('images/ico_close.svg')); ?>" alt="إغلاق">
                    </i>
                </span>
            </div>
...
<div class="modal fade login" id="register" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content relative">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo e(__('التسجيل')); ?></h4>
                <span class="c-pointer" data-dismiss="modal" aria-label="إغلاق">
                    <i class="input-icon field-icon fa">
                        <img src="<?php echo e(url('images/ico_close.svg')); ?>" alt="إغلاق">
                    </i>
...
<?php /**PATH /Users/souheibmadi/Documents/umrahproject/umrah/themes/Mytravel/Layout/parts/login-register-modal.blade.php ENDPATH**/ ?>