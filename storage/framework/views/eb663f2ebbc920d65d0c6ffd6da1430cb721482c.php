...
<div class="card transition-3d-hover shadow-hover-2 item-loop h-100 <?php echo e($wrap_class ?? ''); ?>">
    <div class="position-relative mb-2">
        ...
        <div class="position-absolute top-0 left-0 pt-4 pl-3 featured">
            <?php if($row->is_featured == "1"): ?>
                <span class="badge badge-pill bg-white text-primary px-4 mr-3 py-2 font-size-14 font-weight-normal"><?php echo e(__("مميز")); ?></span>
            <?php endif; ?>
        ...
        <div class="position-absolute top-0 right-0 pt-4 pr-3 btn-wishlist">
            <button type="button" class="p-0 btn btn-sm btn-icon text-white rounded-circle service-wishlist <?php echo e($row->isWishList()); ?>" data-id="<?php echo e($row->id); ?>" data-type="<?php echo e($row->type); ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo e(__("حفظ لوقت لاحق")); ?>">
        ...
        <div class="position-absolute bottom-0 left-0 right-0 text-content">
            <div class="px-3 pb-2">
                ...
                <h2 class="h5 text-white mb-0 font-weight-bold">
                    <small class="mr-1 font-size-14"><?php echo e(__("ابتداءا من")); ?></small>
    ...
    <div class="card-body px-3 py-2">
                ...
                <div class="d-inline-flex align-items-center font-size-17 text-lh-1 text-primary">
                    ...
                    <span class="text-secondary font-size-14 mt-1">
                        <?php if($reviewData['total_review'] > 1): ?>
                            <?php echo e(__(":number تقييمات",["number"=>$reviewData['total_review'] ])); ?>

                        <?php else: ?>
                            <?php echo e(__(":number تقييم",["number"=>$reviewData['total_review'] ])); ?>
        ...
        <div class="g-price d-none">
            <div class="prefix">
                <span class="fr_text"><?php echo e(__(" ابتداءا من")); ?></span>
            </div>
            <div class="price">
...
<?php /**PATH /Users/souheibmadi/Documents/umrahproject/umrah/themes/Mytravel/Tour/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>