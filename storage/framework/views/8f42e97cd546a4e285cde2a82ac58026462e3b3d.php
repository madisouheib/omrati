    ...
    <div class="bravo-list-tour-related product-card-carousel-block product-card-carousel-v5">
        <div class="space-1">
            <div class="w-md-80 w-lg-50 text-center mx-md-auto mt-3">
                <h2 class="section-title text-black font-size-30 font-weight-bold mb-0"><?php echo e(__("قد تعجبك أيضًا ...")); ?></h2>
            </div>
...
<?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/umrah/themes/Mytravel/Tour/Views/frontend/layouts/details/tour-related.blade.php ENDPATH**/ ?>