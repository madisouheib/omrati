    ...
    <div class="row">
        <?php if($translation->include): ?>
            <div class="col-md-6 mb-4">
                <div class="font-weight-bold text-dark mb-3"><?php echo e(__("السعر يشمل")); ?></div>
        ...
        <?php if($translation->exclude): ?>
            <div class="col-md-6 mb-4">
                <div class="font-weight-bold text-dark mb-3"><?php echo e(__("السعر لا يشمل")); ?></div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/umrah/themes/Mytravel/Tour/Views/frontend/layouts/details/tour-include-exclude.blade.php ENDPATH**/ ?>