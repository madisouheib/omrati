            ...
            <div class="input-group border-bottom border-width-2 border-color-1 py-2">
                ...
                <div class="g-map-place border-0 p-0 form-control  height-40 d-flex">
                    <input type="text" name="map_place" placeholder="{{ __('Where are you going?') }}"
                        ...
                        class="font-weight-bold font-size-16 shadow-none hero-form font-weight-bold border-0 p-0">
            ...
            <div class="input-group border-bottom border-width-2 border-color-1 py-2">
                ...
                <div class="smart-search border-0 p-0 form-control  height-40">
                    <input type="text"
                        ...
                        {{ (empty(setting_item('tour_location_search_style')) or setting_item('tour_location_search_style') == 'normal') ? 'readonly' : '' }}
                        placeholder="{{ __('بلد الانطلاق') }}" value="{{ $location_name }}"
                        data-onLoad="{{ __('تحميل...') }}" data-default="{{ json_encode($list_json) }}">
