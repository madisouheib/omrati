            ...
            <div class="border border-color-7 rounded mb-5">
                <div class="border-bottom">
                    @if ($row->discount_percent)
                        <div class="sale-box">
                            <div class="ribbon ribbon--red">{{ __('وفر :text', ['text' => $row->discount_percent]) }}
                            </div>
                        </div>
                    @endif
                    <div class="p-4">
                    ...
                    <div class="p-4">
                        ...
                        <div class="" v-if="person_types">
                            <div class="form-group form-guest-search" v-for="(type,index) in person_types">
                                <span
                                    class="d-block text-gray-1 font-weight-normal mb-2 text-left">@{{ type.name }}</span>
                                <div class="mb-4">
                                ...
                                <div class="border-bottom border-width-2 border-color-1 pb-1">
                                    <div class="flex-center-between mb-1 text-dark font-weight-bold">
                                        ...
                                        <div class="flex-horizontal-center">
                                            ...
                                            <input
                                                class="form-control h-auto width-30 font-weight-bold font-size-16 shadow-none bg-tranparent border-0 rounded p-0 mx-1 text-center"
                                                type="text" v-model="guests" min="1">
                                            <a class="font-size-10 text-dark" href="javascript:;"
                                                @click="addGuestsType()">
                                                <i class="fa fa-chevron-up"></i>
                                            </a>
                            ...
                            <div class="mb-2" v-for="(type,index) in extra_price">
                                <div class="extra-price-wrap d-flex justify-content-between">
                                    <div class="flex-grow-1">
                                        <label><input type="checkbox" v-model="type.enable">
                                            @{{ type.name }}</label>
