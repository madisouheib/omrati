        ...
        <div id="bravo_tour_book_app" class="bravo_single_book " v-cloak>
            <div class="border border-color-7 rounded mb-5">
                ...
                <div class="form-book" :class="{'d-none':enquiry_type!='book'}">
                    <div class="p-4">
                        <span class="d-block text-gray-1 font-weight-normal mb-0 text-left">{{ __("تاريخ البداية") }}</span>
                        <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    <div class="border-bottom border-width-2 border-color-1 pb-1">
                                        <div class="flex-center-between mb-1 text-dark font-weight-bold">
                                            <span class="d-block">
                                                @{{type.desc}} <br>
                                                <small>@{{type.display_price}} {{__("للشخص الواحد")}}</small>
                                            </span>
