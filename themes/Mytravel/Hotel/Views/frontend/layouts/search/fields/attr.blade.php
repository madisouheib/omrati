@if (!empty($field['attr']) && !empty(($attr = \Modules\Core\Models\Attributes::find($field['attr']))))
    @php
        ...
        <div class="item">
            ...
            <div class="mb-4">
                <div class="input-group border-bottom border-width-2 border-color-1 py-2">
                    <i
                        class="icofont-paperclip d-flex align-items-center mr-2 text-primary font-weight-semi-bold font-size-22"></i>
                    ...
                    <div class="smart-search border-0 p-0 form-control height-40">
                        <input type="text" class="smart-select font-weight-bold parent_text form-control" readonly
