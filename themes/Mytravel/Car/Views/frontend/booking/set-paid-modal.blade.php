                    ...
                    <ul class="list-unstyled font-size-1 mb-0 font-size-16">
                        @if($booking->start_date)
                            <li class="d-flex justify-content-between py-2">
                                <div class="label">{{__('تاريخ البداية:')}}</div>
                                <div class="val">
                                    {{display_date($booking->start_date)}}
                                </div>
                            </li>
                            <li class="d-flex justify-content-between py-2">
                                <div class="label">{{__('تاريخ الانتهاء:')}}</div>
                                <div class="val">
                                ...
                                <p class="text-center">
                                    <a data-toggle="modal" data-target="#detailBookingDate{{$booking->code}}" aria-expanded="false"
                                       aria-controls="detailBookingDate{{$booking->code}}">
                                        {{__('التفاصيل')}} <i class="icofont-list"></i>
                                    </a>
                                </p>
                            </div>
                        </li>
            ...
            <div id="basicsCollapsePayment" class="collapse show">
                <div class="card-body px-4 pt-0">
                    <ul class="list-unstyled font-size-1 mb-0 font-size-16">
                        ...
                        @if(!empty($price_item))
                            <li class="d-flex justify-content-between py-2">
                                <div class="label">{{__('سعر التأجير')}}
                                </div>
                                <div class="val">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center">{{__('تفاصيل')}}</h5>
